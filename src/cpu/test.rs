...
pub const EXPECTED_TICKS: [usize; 256] = [
    ...
    4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 0, 12, 0, 16, 0, 16, 8, 16, 0, 16, 0,
    0, 0, 24, 8, 16, 0, 12, 0, 0, 0, 16, 8, 16, 0, 16, 0, 0, 0, 0, 8, 16, 12, 12, 8, 0, 0, 16, 8, 16, 16, 4, 16, 0, 0, 0, 8, 16, 12, 12, 8, 4, 0, 16, 8, 16,
    12, 8, 16, 4, 0, 0, 8, 16,
];
...
fn ticks_expected() {
    ...
    for (i, instr) in INSTR_TABLE.iter().enumerate() {
        ...
        info!("Testing {}: {}: {}? {:?}", instr, i, cpu.registers.pc, &bus.memory[0..10]);
