...
with open('gb_opcodes.txt') as f:
    ...
    # Get the indexes that match a certain regex. This will be used to create a tree structure that will be used to store information about the different types of opcodes on the gameboy.
